...
EDS_BEGIN_NAMESPACE
template <class... PARMS> struct DelegateResourceManager : public Resource {
  constexpr DelegateResourceManager() noexcept = default;
  constexpr DelegateResourceManager(const DelegateResourceManager &) noexcept =
      default;
  constexpr DelegateResourceManager(DelegateResourceManager &&) noexcept =
      default;
...
template <> struct DelegateResourceManager<> : public Resource {
  constexpr DelegateResourceManager() noexcept = default;
  constexpr DelegateResourceManager(const DelegateResourceManager &) noexcept =
      default;
  constexpr DelegateResourceManager(DelegateResourceManager &&) noexcept =
