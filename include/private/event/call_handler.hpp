...
class CallHandler<FunctionPointer, PARAMS...> :
    ...
    public:
          ...
          constexpr CallHandler(void (*call_back)(PARAMS...) noexcept, delegate_Resource_manager_t *d) noexcept
...
template <class... PARAMS>
class CallHandler<FunctionType, PARAMS...> :
      public Subscriber<PARAMS...> {
    public:
        using CallBack_t = void(PARAMS...) noexcept;
        using Subscriber_t = Subscriber<PARAMS...>;
    ...
    public:
        ...
        constexpr CallHandler(const CLASS *class_instance, void (CLASS::*call_back)(PARAMS...) const noexcept, 
              delegate_Resource_manager_t *d) noexcept
                  : m_call_back(std::make_shared<MemberCall<VoidReturnCode,Constant,NoException,CLASS,PARAMS...>>(class_instance,call_back)), m_resource_manager(d) { 
        ...
        constexpr CallHandler(CLASS *class_instance, void (CLASS::*call_back)(PARAMS...) noexcept, 
              delegate_Resource_manager_t *d) noexcept
                  : m_call_back(std::make_shared<MemberCall<VoidReturnCode,NotConstant,NoException,CLASS,PARAMS...>>(class_instance,call_back)), m_resource_manager(d) { 
                      m_resource_id = m_call_back->hash();
        }
 ...
 */
template <>
class CallHandler<FunctionType> :
      public Subscriber<> {
    public:
        using CallBack_t = void() noexcept;
        using Subscriber_t = Subscriber<>;
