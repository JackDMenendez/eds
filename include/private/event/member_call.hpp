...
template <typename RC, typename CONSTANT, typename EXCEPT_REGIME,
          typename CLASS, typename... PARMS>
...
public:
  ...
  constexpr MemberCallBase &
  operator=(const MemberCallBase &) noexcept = default;
...
public:
  constexpr MemberCall(CLASS *object,
  ...
  constexpr auto operator==(const Caller<PARMS...> &other) const noexcept
      -> bool {
...
member(CLASS &object, void (CLASS::*member)(PARMS...))
    -> std::unique_ptr<MemberCall<VoidReturnCode, NotConstant, YesException,
CLASS, PARMS...>> { return
std::make_unique<MemberCall<VoidReturnCode,NotConstant,YesException, CLASS,
PARMS...>>(&object, member);
}
...
member(CLASS &object, void (CLASS::*member)())
    -> std::unique_ptr<MemberCall<VoidReturnCode, NotConstant, YesException,
CLASS>> { return
std::make_unique<MemberCall<VoidReturnCode,NotConstant,YesException,
CLASS>>(&object, member);
}
...
PARMS...>> { return std::make_unique<MemberCall<VoidReturnCode, Constant,
YesException, CLASS, PARMS...>>(&object, member);
}
template <typename CLASS>
constexpr auto
member(const CLASS &object, void (CLASS::*member)() const)
    -> std::unique_ptr<MemberCall<VoidReturnCode, Constant, YesException,
CLASS>> { return std::make_unique<MemberCall<VoidReturnCode, Constant,
YesException, CLASS>>(&object, member);
}
*/
template <typename CLASS, typename... PARMS>
constexpr auto
create_method_call(CLASS *object,
                   void (CLASS::*member)(PARMS...) noexcept) noexcept
    -> MemberCall<VoidReturnCode, NotConstant, NoException, CLASS, PARMS...> {
  return MemberCall<VoidReturnCode, NotConstant, NoException, CLASS, PARMS...>(
      object, member);
}
template <typename CLASS, typename... PARMS>
constexpr auto
...
constexpr auto create_method_call(CLASS &object,
                                  void (CLASS::*member)() noexcept) noexcept
    -> MemberCall<VoidReturnCode, NotConstant, NoException, CLASS> {
  return MemberCall<VoidReturnCode, NotConstant, NoException, CLASS>(&object,
                                                                     member);
}
template <typename CLASS>
constexpr auto create_method_call(CLASS *object,
...
constexpr auto create_method_call(const CLASS &object,
                                  void (CLASS::*member)(PARMS...)
                                      const noexcept) noexcept
    -> MemberCall<VoidReturnCode, Constant, NoException, CLASS, PARMS...> {
  return MemberCall<VoidReturnCode, Constant, NoException, CLASS, PARMS...>(
      &object, member);
}
template <typename CLASS, typename... PARMS>
constexpr auto create_method_call(const CLASS *object,
...
constexpr auto create_method_call(const CLASS &object,
  ...
  return MemberCall<VoidReturnCode, Constant, NoException, CLASS>(&object,
                                                                  member);
}
...
template <typename CLASS>
constexpr auto create_method_call(CLASS *object, void (CLASS::*member)()
                                                     const noexcept) noexcept
    -> MemberCall<VoidReturnCode, Constant, NoException, CLASS> {
  return MemberCall<VoidReturnCode, Constant, NoException, CLASS>(object,
                                                                  member);
...
member(CLASS *object, void (CLASS::*member)(PARMS...))
    -> std::unique_ptr<MemberCall<VoidReturnCode, NotConstant, YesException,
CLASS, PARMS...>> { return std::make_unique<MemberCall<VoidReturnCode,
NotConstant, YesException, CLASS, PARMS...>>(object, member);
}
template <typename CLASS>
constexpr auto
member(CLASS *object, void (CLASS::*member)())
    -> std::unique_ptr<MemberCall<VoidReturnCode, NotConstant, YesException,
CLASS>> { return std::make_unique<MemberCall<VoidReturnCode, NotConstant,
YesException, CLASS>>(object, member);
}
*/
/* template <typename CLASS, typename... PARMS>
constexpr auto
create_method_call(CLASS &object, void (CLASS::*member)(PARMS...) noexcept)
noexcept
    -> MemberCall<VoidReturnCode, NotConstant, NoException, CLASS, PARMS...> {
        return MemberCall<VoidReturnCode, NotConstant, NoException, CLASS,
PARMS...>(&object, member);
}*/
/*
template <typename CLASS, typename... PARMS>
...
member(CLASS *object, void (CLASS::*member)() noexcept)
    -> std::unique_ptr<MemberCall<VoidReturnCode, NotConstant, NoException,
CLASS>> { return std::make_unique<MemberCall<VoidReturnCode, NotConstant,
NoException, CLASS>>(object, member);
}
template <typename CLASS, typename... PARMS>
constexpr auto
member(const CLASS *object, void (CLASS::*member)(PARMS...) const)
...
PARMS...>> { return std::make_unique<MemberCall<VoidReturnCode, Constant,
NoException, CLASS, PARMS...>>(object, member);
}
template <typename CLASS>
constexpr auto
member(const CLASS *object, void (CLASS::*member)() const noexcept)
    -> std::unique_ptr<MemberCall<VoidReturnCode, Constant, NoException, CLASS>>
{ return std::make_unique<MemberCall<VoidReturnCode, Constant, NoException,
CLASS>>(object, member);
}
*/
EDS_END_NAMESPACE
