...
template <typename T> 
constexpr static bool is_psuedo_v = is_psuedo<T>::value;
template <typename T>
...
template <typename T> constexpr static bool is_resource_handling_regime_v = std::is_base_of_v<ResourceHandlingRegime, T>;
